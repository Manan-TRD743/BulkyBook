...
function loadDataTable(StartDate, EndDate) { 
    if (datatable) {
        ...
        datatable.ajax.url('/Admin/Report/GetTransactionReport?StartDate=' + StartDate + '&EndDate=' + EndDate).load();
        return;
    }
    datatable = $('#tblData').DataTable({
        "ajax": {
            url: '/Admin/Report/GetTransactionReport?StartDate=' + StartDate + '&EndDate=' + EndDate,
            type: 'GET',
            dataType: 'json'
        },
        "columns": [
